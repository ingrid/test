...
define(["exports", "./Util", "./Vector", "./Entity"], function (exports, _Util, _Vector, _Entity2) {
	...
	var Sprite = function (_Entity) {
		...
		function Sprite(x, y, coms) {
			...
			_this.velocity = (0, _Vector2.default)(0, 0);
			_this.acceleration = (0, _Vector2.default)(0, 0);

			// How much the render position is affected by the camera
			_this.parallax = (0, _Vector2.default)(1, 1);
		...
		_createClass(Sprite, [{
			...
			value: function setImage(url) {
				if (_Util2.default.cache[url] === undefined) {
					...
					this.image = _Util2.default.cache[url];
					this.width = this.image.naturalWidth;
					this.height = this.image.naturalHeight;
					this.imageLoaded();
				}
