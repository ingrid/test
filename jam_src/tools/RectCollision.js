...
lib.sprite.init = function(){
  this.immovable = false;	// Can this sprite be pushed around by collisions
	...
	this.overlaps = function(other, callback) { return jam.Collision.overlaps(this, other, callback); }
	this.collide = function(other) { return jam.Collision.collide(this, other); }
