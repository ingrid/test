...
*/
var Game;
export default Game = function(width, height, parentElement){
	...
	this.camera = {
		scroll:Vector(0,0),
		size:Vector(this.width, this.height),
		follow:null,
	};
	...
	this.update = function(){
		...
		this._children = this._children.filter(function(x,i,a){ return this._remove.indexOf(x) === -1 }.bind(this));
		this._remove = [];
	...
	this.sortSprites = function(){
		this._children.sort(function(a,b){ return b._layer - a._layer; });
	}
};
